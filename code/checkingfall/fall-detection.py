...
global par,args,device,inp_dets,inp_pose,detect_model,pose_model,max_age,tracker,action_model,resize_fn
global cam_source,cam,outvid,codec,writer
global fps_time, f, flag, par, source
source = 'duel2.avi'
#source = 2
fps_time = 0
f = 0
...
def insert():
    ...
    app.send_text(datas["event_location"]+datas["event_desc"])
def init1():
    global par,args,device,inp_dets,inp_pose,detect_model,pose_model,max_age,tracker,action_model,resize_fn
    global cam_source,cam,outvid,codec,writer
    global fps_time, f, flag, par, source
    ...
    par.add_argument('--device', type=str, default='cpu',
                     help='Device to run model on cpu or cpu.')
    args = par.parse_args()
