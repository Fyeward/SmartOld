...
global pixel_per_metric,input_video,output_activity_path,model_path,people_info_path,camera_turned,python_path
# 全局变量
pixel_per_metric = None
input_video = None
output_activity_path = '../supervision/activity'
model_path = '../models/face_recognition_hognew.pickle'
people_info_path = '../info/people_info.csv'
camera_turned = 0
python_path = '/home/fyeward/anaconda3/envs/tf/bin/python3.6' # your python path

global FACE_ACTUAL_WIDTH,VIDEO_WIDTH,VIDEO_HEIGHT,ANGLE,ACTUAL_DISTANCE_LIMIT
# 全局常量
...
global id_card_to_name,id_card_to_type
