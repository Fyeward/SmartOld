...
def on_message(ws, message):
    ...
    payload = {
        'event_desc': json.loads(message)['result'],
    }
    ...
    app.send_text(content=payload["event_desc"])
    r = requests.post("http://47.102.213.152:8080/EventManage/addEvent", data=json.dumps(payload),
